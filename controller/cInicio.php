...
if (isset($_GET["cerrar"])) {
    ...
    $_SESSION["fechaConexionAnterior"] = new DateTime($_SESSION["DAW215LoginLogoutPOO"]->getFechaHoraUltimaConexion());
    ...
    if ($_SESSION["DAW215LoginLogoutPOO"]->getNumAccesos() == 0) {
        ...
        $mensajeDeBienvenida = "Es un placer verte de nuevo, " .  ucfirst($_SESSION["DAW215LoginLogoutPOO"]->getDescUsuario()) .". Esta es la " . $_SESSION["DAW215LoginLogoutPOO"]->getNumAccesos() + 1 . "ª vez que me visitas. La ultima vez que lo hiciste fue el " . $_SESSION[fechaConexionAnterior]->format("d \d\e\l m \d\e Y \a \l\a\s H:i:s");
    }
    //Cosas del idioma
