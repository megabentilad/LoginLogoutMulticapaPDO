...
if(isset($_REQUEST['pagina'])){
    ...
    if (isset($_POST['enviar'])) { //Si se ha pulsado enviar
        ...
        //Permitir entrada
        if($_POST['desc'] === $_SESSION['DAW215LoginLogoutPOOUsuario']->getDescUsuario()){
        ...
        if ($entradaOK) {
            ...
            $objetoUsuario = UsuarioPDO::modificarUsuario($_SESSION['DAW215LoginLogoutPOOUsuario']->getCodUsuario(), $descUsuario);
